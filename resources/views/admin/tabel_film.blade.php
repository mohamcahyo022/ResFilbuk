                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold">{{ $film->sutradara }}</span>
                    </td>
                    <td>
                        <center>
                        <a href="/detail-film/{{$film->id}}" class="badge bg-gradient-success border-0">Detail</a>
                      <form action="/hapus-film-admin/{{ $film->id }}" method="post" class="d-inline" >
                        @method('delete')
                        @csrf
