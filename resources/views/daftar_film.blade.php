                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Resensi <span>Film</span></h2>
                    ...
                    <div class="row align-items-end mb-60">
                        <div class="col-lg-6">
                            <div class="section-title text-center text-lg-left">
                                ...
                                <h2 class="title">Daftar Semua Resensi Film</h2>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="movie-item movie-item-three mb-50">
                                <div class="movie-poster">
                                    ...
                                    <ul class="overlay-btn">
                                        ...
                                        <li><a href="detail-film/{{$film->id}}" class="btn">Details</a></li>
                                    </ul>
                                </div>
                                <div class="movie-content">
                                    ...
                                    <div class="bottom">
                                        <ul>
                                            ...
                                            <li>
                                                <span class="duration"><i class="far fa-clock"></i>{{$film->durasi}}</span>
                                                {{-- <span class="rating"><i class="fas fa-thumbs-up"></i> 4.5</span> --}}
                                            </li>
                                        </ul>
                                    </div>
                                </div>
