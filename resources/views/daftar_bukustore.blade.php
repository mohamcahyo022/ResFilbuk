                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Rekomendasi <span>Buku</span></h2>
                    ...
                    <div class="row align-items-end mb-60">
                        <div class="col-lg-6">
                            <div class="section-title text-center text-lg-left">
                                ...
                                <h2 class="title">Semua Rekomendasi Buku</h2>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="movie-item movie-item-three mb-50">
                                <div class="movie-poster">
                                    ...
                                    <ul class="overlay-btn">
                                        <li><a href="detail-perpus/{{$buku->id}}" class="btn">Details</a></li>
                                    </ul>
                                </div>
                                <div class="movie-content">
                                    <div class="top">
                                        <h5 class="title"><a href="detail-perpus/{{$buku->id}}">{{$buku->judul}}</a></h5>
                                        <span class="date">{{$buku->rilis}}</span>
                                    </div>
                                    <div class="bottom">
                                        <ul>
                                            <li><span class="quality">{{$buku->genre}}</span></li>
                                         </ul>
                                    </div>
                                </div>
                            </div>
